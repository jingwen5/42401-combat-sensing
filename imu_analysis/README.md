...
4. Run imu_find_thresholds.m to compare statistics across multiple CSV files and tune detection thresholds
5. Run imu_split_events.py to split long recordings into individual event windows for analysis
...
- Update the OUTPUT_FILE in imu_serial.py before each test to keep recordings organized.